...
import type { AdapterKind, PluginPageManifest, PluginSettingsTabManifest, PluginSettingsUiManifest } from '../types.js';
...
export interface PluginDownloadCoreApi {
    ...
    listHistory(filters?: PluginDownloadHistoryQuery): Promise<{
    ...
    setQueueItemSpeedLimit(clientId: number, externalId: string, maxDownloadSpeed?: number, maxUploadSpeed?: number): Promise<void>;
    ...
    setQueueItemFilesPriority(clientId: number, externalId: string, files: Array<{
        index: number;
        priority: string;
    }>): Promise<void>;
...
export interface PluginContext {
    ...
    on<TPayload = unknown>(event: string, listener: (payload: TPayload) => void | Promise<void>): () => void;
