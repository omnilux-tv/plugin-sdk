...
export type {
  ...
  PluginRuntimeEgressApi,
  PluginRuntimeHttpClient,
  PluginRuntimePlexWatchlistApi,
  PluginRuntimePlexWatchlistConfig,
  PluginRuntimePlexWatchlistRunResult,
  PluginRuntimePlexWatchlistSyncResult,
  PluginRuntimePreferenceScope,
  PluginRuntimeRouteApi,
  PluginRuntimeUserPreferencesApi,
